...
const slides = [
  {
    ...
    headline: "Gear Buat Melangkah Lebih Jauh",
    sub: "Cek gear terbaik kita biar petualangan lo makin gacor tanpa drama.",
    ctaText: "Gas Cek Gear",
    ctaLink: "/store",
    badge: "Gear Baru Nih",
  },
  {
    image: heroOutdoor,
    headline: "Lagi Diskon Nih (Up to 30%)",
    sub: "Gear mantap harga bersahabat buat nemenin hari-hari lo.",
    ctaText: "Sikat Diskonnya",
    ctaLink: "/store?sort=Diskon",
    badge: "Special Offer",
  },
  {
    image: lifestyleCamping,
    headline: "Flash Sale Lagi Gas! 🔥",
    sub: "Waktunya dikit, jangan sampe gear inceran lo diambil orang.",
